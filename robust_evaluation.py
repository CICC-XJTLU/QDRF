...
def main():
    ...
    if isinstance(args['base']['missing_rate_eval_test'], dict):
        cur_seed = 1115  #seed：1111, 1112, 1113
        ...
        result = evaluate(model, dataLoader, metrics)
        print(f'seed: {cur_seed}, result: {result}')
        return
    ...
    for cur_r in tqdm(missing_rate_list, desc="Missing Rates", unit="rate"):
        ...
        if dataset_name == 'sims':
            for _, cur_seed in enumerate([1111,1112,1115]):
                best_ckpt = os.path.join(f'ckpt/{dataset_name}/best_test_{key_eval}_{cur_seed}.pth')
            ...
            if key_eval == 'Has0_acc_2':
                Has0_acc_2_avg = (test_results_list[0]['Has0_acc_2'] + test_results_list[1]['Has0_acc_2'] +
                                  test_results_list[2]['Has0_acc_2']) / 3
                Has0_F1_score_avg = (test_results_list[0]['Has0_F1_score'] + test_results_list[1]['Has0_F1_score'] +
                                     test_results_list[2]['Has0_F1_score']) / 3
                print(
                ...
                Non0_acc_2_avg = (test_results_list[0]['Non0_acc_2'] +
                                  test_results_list[1]['Non0_acc_2'] + test_results_list[2]['Non0_acc_2']) / 3
                Non0_F1_score_avg = (test_results_list[0]['Non0_F1_score'] +
                                     test_results_list[1]['Non0_F1_score'] + test_results_list[2]['Non0_F1_score']) / 3
                print(
                ...
                Mult_acc_7_avg = (test_results_list[0]['Mult_acc_7'] + test_results_list[1]['Mult_acc_7'] +
                                  test_results_list[2]['Mult_acc_7']) / 3
